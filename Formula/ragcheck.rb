class Ragcheck < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/itamaker/ragcheck-skill/releases/download/v0.2.0/ragcheck_0.2.0_darwin_arm64.tar.gz"
      sha256 "140484cf3a0da603ca3fee98293cb8a216c7a86565ccbff0d8f4d85b820b67a6"
    else
      url "https://github.com/itamaker/ragcheck-skill/releases/download/v0.2.0/ragcheck_0.2.0_darwin_amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/itamaker/ragcheck-skill/releases/download/v0.2.0/ragcheck_0.2.0_linux_arm64.tar.gz"
      sha256 "b0eeb3a7d6ca1d138f8153595763102f0e704d0f5de2da69065916a79f6d2171"
    else
      url "https://github.com/itamaker/ragcheck-skill/releases/download/v0.2.0/ragcheck_0.2.0_linux_amd64.tar.gz"
