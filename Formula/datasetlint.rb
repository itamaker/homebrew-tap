class Datasetlint < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/itamaker/datasetlint/releases/download/v0.2.0/datasetlint_0.2.0_darwin_arm64.tar.gz"
      sha256 "fa95ffa766107f629e6adb6c5982926e8eb4be2d0b875522b63878323da8c4bf"
    else
      url "https://github.com/itamaker/datasetlint/releases/download/v0.2.0/datasetlint_0.2.0_darwin_amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/itamaker/datasetlint/releases/download/v0.2.0/datasetlint_0.2.0_linux_arm64.tar.gz"
      sha256 "369235c23d2d6e18adf3594aaee84faaa0b292f9e3cb0a36a486736fd48e5e58"
    else
      url "https://github.com/itamaker/datasetlint/releases/download/v0.2.0/datasetlint_0.2.0_linux_amd64.tar.gz"
