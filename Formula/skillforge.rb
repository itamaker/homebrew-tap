class Skillforge < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/itamaker/forge-skill/releases/download/v0.2.0/skillforge_0.2.0_darwin_arm64.tar.gz"
      sha256 "e95dafc517482f2bb0edeb2589534fe32eb958460a33630cf0897d58d3386c5c"
    else
      url "https://github.com/itamaker/forge-skill/releases/download/v0.2.0/skillforge_0.2.0_darwin_amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/itamaker/forge-skill/releases/download/v0.2.0/skillforge_0.2.0_linux_arm64.tar.gz"
      sha256 "eebaf362691bd868939d4656ada676f0980d33edf6d4182ca991cdf720c057b8"
    else
      url "https://github.com/itamaker/forge-skill/releases/download/v0.2.0/skillforge_0.2.0_linux_amd64.tar.gz"
